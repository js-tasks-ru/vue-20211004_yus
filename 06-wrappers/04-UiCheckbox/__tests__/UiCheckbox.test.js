...
describe('wrappers/UiCheckbox', () => {
  describe('UiCheckbox', () => {
    ...
    it('UiCheckbox должен порождать событие обновления значения с новым логическим значением при изменении значения checkbox', async () => {
      const wrapper = shallowMount(UiCheckbox, { props: { modelValue: false } });
